...
<body>
	...
	<h1 style="color: green; font-size: 40px;" align="center">we integraded nexus also/cd</h1>
	<h1 style="color: brown; font-size: 40px;" align="center">we are done with nexus also</h1>
